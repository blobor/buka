...
describe('SkipassCard', () => {
  it('should renders correctly', () => {
    const skipass = {
      ...
      purchaseDate: moment('2015-03-09').utcOffset(0, true).toDate(),
      lifts: [],
      isUnUsed: false,
      balance: 0,
      syncDate: moment('2017-01-09').utcOffset(0, true).toDate(),
      updateDate: moment('2017-01-09').utcOffset(0, true).toDate()
    }
